...
*   **[Lesson 1: Application-Level Global Instructions](lessons/Lesson_1_Application_Level_Instructions.md)**
...
*   **[Lesson 4: Stateful Prompting (The Folder Architecture)](lessons/Lesson_4_Stateful_Prompting.md)**
    *   *Learn how to offload static instructions from your daily prompts directly into your project's file structure.*

*   **[Lesson 5: InfoSec & Prompt Engineering](lessons/Lesson_5_InfoSec_and_Prompting.md)**
    *   *Learn how to safely deploy autonomous agents by enforcing Confidentiality, Integrity, and Availability.*

### Module 1 Capstone
*   **[Capstone Project: The Thin Prompt Workflow](lessons/Module_1_Capstone.md)**
...
*   **[Lesson 6: Packaging Workflows (The `skills/` Directory)](lessons/Lesson_6_Packaging_Workflows.md)**
    *   *How to save your best Thin Prompts as reusable, automated scripts.*

*   **[Lesson 7: Agentic Delegation (Sub-Agents)](lessons/Lesson_7_Agentic_Delegation.md)**
    *   *How to build a team of specialized AI workers to execute tasks in parallel.*

### Module 2 Capstone
*   **[Capstone Project: The Automated File Processor](lessons/Module_2_Capstone.md)**
...
*   **[Lesson 8: Dynamic Memory & Self-Correction](lessons/Lesson_8_Dynamic_Memory_and_Self_Correction.md)**
    *   *How to program an AI to autonomously document its failures and learn from them.*

*   **[Lesson 9: Continuous Validation & Sandboxing](lessons/Lesson_9_Continuous_Validation_and_Sandboxing.md)**
    *   *Never trust AI-generated code blindly. Build environments that test it automatically.*

*   **[Lesson 10: Multi-Agent Orchestration](lessons/Lesson_10_Multi_Agent_Orchestration.md)**
    *   *Scaling up: Building an assembly line of specialized AI workers.*

### Module 3 Capstone
*   **[Capstone Project: The AI Software Factory](lessons/Module_3_Capstone.md)**
